    ...
    <section className="py-20 container mx-auto px-4 md:px-6">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold mb-6">
          Featured <span className="text-cyber-cyan glow-text">Projects</span>
        </h2>
        <p className="text-gray-400 max-w-2xl mx-auto text-lg">
          Showcasing my latest AI projects and automation solutions from my professional portfolio
        </p>
      </motion.div>
